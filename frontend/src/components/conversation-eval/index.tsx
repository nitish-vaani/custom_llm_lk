...
// const parseEvalData = (resultText: string): ParsedEvalData | null => {
//   try {
...
//     let jsonData: ParsedEvalData;
//     try {
//       jsonData = JSON.parse(cleanedResult) as ParsedEvalData;
//     } catch (e) {
...
//   // Handle the case where evalData is an object with a result string property
//   const resultText = evalData.result || 
//                     (typeof evalData === 'string' ? evalData : null);
...
//   const parsedData = parseEvalData(resultText);
